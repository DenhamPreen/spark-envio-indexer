import { type OpenOrderEvent, type Order, Market, type User, MarketOrder } from "generated";
import { getISOTime } from "../utils";
import { getHash } from "../utils";
import { nanoid } from "nanoid";

// Define a handler for the OpenOrderEvent within a specific market
MarketOrder.OpenOrderEvent.handlerWithLoader({
	...
	handler: async ({ event, context, loaderReturn }) => {
		...
		const openOrderEvent: OpenOrderEvent = {
			...
			limitType: event.params.limit_type.case,
